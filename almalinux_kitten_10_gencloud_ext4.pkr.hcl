# AlmaLinux OS Kitten 10 Packer template for Cloud-init included and OpenStack compatible Generic Cloud (ext4) images

source "qemu" "almalinux_kitten_10_gencloud_ext4_x86_64" {
  ...
  boot_command       = var.gencloud_ext4_boot_command_kitten_10_x86_64
  ...
  vm_name            = "AlmaLinux-Kitten-GenericCloud-ext4-10-${formatdate("YYYYMMDD", timestamp())}.${var.build_number}.x86_64.qcow2"
  cpu_model          = "host"
  cpus               = var.cpus
  efi_boot           = true
...
source "qemu" "almalinux_kitten_10_gencloud_ext4_aarch64" {
  ...
  ssh_password       = var.gencloud_ssh_password
  ssh_timeout        = var.ssh_timeout
  boot_command       = local.aarch64_gencloud_ext4_boot_command_kitten_10
  boot_wait          = var.boot_wait
  ...
  net_device         = "virtio-net"
  qemu_binary        = var.qemu_binary
  vm_name            = "AlmaLinux-Kitten-GenericCloud-ext4-10-${formatdate("YYYYMMDD", timestamp())}.${var.build_number}.aarch64.qcow2"
...
source "qemu" "almalinux_kitten_10_gencloud_ext4_ppc64le" {
  ...
  ssh_password       = var.gencloud_ssh_password
  ssh_timeout        = var.ssh_timeout
  boot_command       = local.gencloud_ext4_boot_command_kitten_10_ppc64le
  ...
  net_device         = "virtio-net"
  qemu_binary        = var.qemu_binary
  vm_name            = "AlmaLinux-Kitten-GenericCloud-ext4-10-${formatdate("YYYYMMDD", timestamp())}.${var.build_number}.ppc64le.qcow2"
  cpus               = var.cpus
}

source "qemu" "almalinux_kitten_10_gencloud_ext4_x86_64_v2" {
  ...
  ssh_password       = var.gencloud_ssh_password
  ssh_timeout        = var.ssh_timeout
  boot_command       = var.gencloud_ext4_boot_command_kitten_10_x86_64_v2
  boot_wait          = var.boot_wait
  accelerator        = "kvm"
  disk_interface     = "virtio-scsi"
  disk_size          = var.gencloud_disk_size
  ...
  net_device         = "virtio-net"
  qemu_binary        = var.qemu_binary
  vm_name            = "AlmaLinux-Kitten-GenericCloud-ext4-10-${formatdate("YYYYMMDD", timestamp())}.${var.build_number}.x86_64_v2.qcow2"
  cpu_model          = "Nehalem"
  cpus               = var.cpus
  efi_boot           = true
  efi_firmware_code  = var.ovmf_code
