# AlmaLinux OS 10 kickstart file for Cloud-init included and OpenStack compatible Generic Cloud images on s390x
...
url --url https://repo.almalinux.org/almalinux/10/BaseOS/s390x/os
text
skipx
eula --agreed
firstboot --disabled
