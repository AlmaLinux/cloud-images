# AlmaLinux OS 9 kickstart file for GCP VM images on aarch64
...
# From https://github.com/GoogleCloudPlatform/compute-image-tools/blob/master/daisy_workflows/image_build/enterprise_linux/kickstart/almalinux_9.cfg
...
bootloader --timeout=0 --location=mbr --append="net.ifnames=0 biosdevname=0 crashkernel=auto"
...
# permit root login via SSH with password authetication (disabled later via ansible)
