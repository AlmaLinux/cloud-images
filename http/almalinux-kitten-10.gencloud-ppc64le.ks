# AlmaLinux OS Kitten 10 kickstart file for Cloud-init included and OpenStack compatible Generic Cloud images on ppc64le

url --url https://kitten.repo.almalinux.org/10-kitten/BaseOS/ppc64le/os
text
lang en_US.UTF-8
keyboard us
timezone UTC --utc
