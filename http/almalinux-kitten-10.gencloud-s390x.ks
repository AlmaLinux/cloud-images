# AlmaLinux OS Kitten 10 kickstart file for Cloud-init included and OpenStack compatible Generic Cloud images on s390x
...
url --url https://kitten.repo.almalinux.org/10-kitten/BaseOS/s390x/os
text
skipx
eula --agreed
firstboot --disabled
