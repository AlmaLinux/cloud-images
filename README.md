...
| [AZURE_MARKETPLACE.md](AZURE_MARKETPLACE.md) | `azure-to-marketplace.yml` | Publish VHD images to Azure Marketplace via the Partner Center Product Ingestion API |
